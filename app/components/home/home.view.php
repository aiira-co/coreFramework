<section class="banner bg-white ad-section no-padding"
    ...
    <div class="ad-card ad-round" style="height:400px;  background-image:url('<?=CDN;?>assets/images/bg.jpg'); ">
...
<br>
        ...
        <br>
        <center>
            <a routerLink="/account"  class="ad-btn ad-md ad-flat btn-dark text-upper ad-spread ad-block">
                &nbsp; My Account &nbsp;
            </a>
        </center>
...
<section class="ad-section">
    <div class="wrapper">
        ...
        <div class="ad-card ad-flat text-center ad-center">
            ...
            <a target="_blank" href="https://github.com/air-Design/coreFramework" class="ad-btn ad-round ad-icon btn-prim ad-shadow">
                <i class="fa fa-caret-up"></i>
            </a>
            <br>
            <br>
        ...
        <div class="ad-card ad-flat text-center ad-center">
            ...
            Its simple and easy to use, extensible with composer, & comes with CoreModel library
            </p>
            <a target="_blank" href="https://github.com/air-Design/cqured" class="ad-btn ad-round ad-icon btn-prim ad-shadow">
                <i class="fa fa-caret-up"></i>
            </a>
            <br>
            <br>
